...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedView_hasTitle() {
        ...
        XCTAssertEqual(sut.title, localized("FEED_VIEW_TITLE", table: "Feed"))
    }
...
//        XCTAssertFalse(sut.isShowingLoadingIndicator)
    ...
    func test_feedImageView_cancelImageLoadingWhenNotVisibleAnymore() {
        ...
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [image0, image1])
        XCTAssertEqual(loader.cancelledImagesURLs, [], "Expected no image URL requests until view become visible")
        
        sut.simulateFeedImageViewNotVisible(at: 0)
        XCTAssertEqual(loader.cancelledImagesURLs, [image0.url], "Expected first image URL request once first view become visible")
        
        sut.simulateFeedImageViewNotVisible(at: 1)
        XCTAssertEqual(loader.cancelledImagesURLs, [image0.url, image1.url], "Expected second image URL request once second view become visible")
    }
